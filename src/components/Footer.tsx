...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="border-t border-white/10 bg-infrastructure-dark/50">
      <div className="container-width px-5 sm:px-6 py-12 md:py-16 pb-24 sm:pb-12 md:pb-16">
        {/* Main Footer Grid */}
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-4 lg:gap-10">
          ...
          <div className="flex flex-col items-center sm:items-start">
            ...
            <p className="mt-4 text-sm text-white/70 leading-relaxed max-w-[280px] text-center sm:text-left">
              Customer acquisition infrastructure for high-value service businesses.
            </p>
            <p className="mt-2 text-sm text-white/70 leading-relaxed max-w-[280px] text-center sm:text-left">
              Remote-first. Serving clients globally from Dhaka, Bangladesh.
            </p>
            <nav aria-label="Social media links" className="mt-6">
              <ul className="flex items-center justify-center sm:justify-start gap-1">
                {socialLinks.map((social) => (
                  <li key={social.name}>
                    <a
                      ...
                      className="flex items-center justify-center w-11 h-11 rounded-lg text-white/50 hover:text-white hover:bg-white/5 transition-colors duration-200"
          ...
          <address className="not-italic flex flex-col items-center sm:items-start">
            <h4 className="text-sm font-semibold tracking-tight text-white mb-5">
              Contact
            </h4>
            <ul className="space-y-1">
              <li>
                <a
                  ...
                  className="group flex items-center justify-center sm:justify-start gap-3 py-2.5 text-sm text-white/70 hover:text-white transition-colors"
                >
