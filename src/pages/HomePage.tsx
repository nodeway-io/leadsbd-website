                ...
                <GlassCard variant="strong" className="p-6 md:p-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-4 p-4 rounded-xl bg-white/[0.03] border border-white/5">
                      ...
                      <div>
                        <h4 className="font-semibold text-foreground text-sm mb-1">Response Speed</h4>
                        <p className="text-xs text-muted-foreground">Auto follow-ups + booking triggers</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-4 p-4 rounded-xl bg-white/[0.03] border border-white/5">
                      <div className="p-2 rounded-lg bg-primary/10">
                      ...
                      <div>
                        <h4 className="font-semibold text-foreground text-sm mb-1">Conversion Path</h4>
                        <p className="text-xs text-muted-foreground">Landing + qualification + booking</p>
                      </div>
                    </div>
                  </div>
